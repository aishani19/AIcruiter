# Alcruiter :crystal_ball: :computer:

</div>

Alcruiter is your ultimate AI-powered interview preparation assistant. Whether you're gearing up for technical, behavioral, or industry-specific interviews, Alcruiter provides personalized and interactive mock interviews to help you ace the big day. 
...
To run Alcruiter locally, follow these steps:
...
5. Open your browser and go to `http://localhost:5173` to use the frontend of Alcruiter.
...
To run Alcruiter, you need to configure the following environment variables in a `.env` file:
...
### Be sure to give Alcruiter a try and take your interview prep to the next level! 📈
